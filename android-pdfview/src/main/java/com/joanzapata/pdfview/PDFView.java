...
public class PDFView extends SurfaceView {
    ...
    void showPage(int pageNb) {
        ...
        // Reset the zoom and center the page on the screen - KC İPTAL ETTİ
        resetZoom();
        if (swipeVertical)
    ...
    public void setDoubleTapListener(DragPinchListener.OnDoubleTapListener listener){
        this.dragPinchManager.setDoubleTapListener(listener);
    }
