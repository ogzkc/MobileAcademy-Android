...
public class VectorComment extends Vector<Comment> implements KvmSerializable {
    
    
    public VectorComment(){}
    
    public VectorComment(SoapObject soapObject)
    {
        if (soapObject == null)
            return;
        if (soapObject != null){
